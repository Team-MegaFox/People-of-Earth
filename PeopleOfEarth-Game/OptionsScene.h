...
public:
	...
	virtual void init(const Viewport& window) override
	{
		GameObject* effectsSlider = (new GameObject("Effects Volume Slider"))
			->addGUIComponent(new GUISlider(glm::vec4(0.2f, 0.2f, 0.05f, 0.5f), glm::vec4(0.0f)));

		GameObject* effectsBox = (new GameObject("Effects Volume Text Box"))
			->addGUIComponent(new GUITextBox(glm::vec4(0.17f, 0.7f, 0.11f, 0.09f), glm::vec4(0.0f, 8.0f, 0.0f, 0.0f), "0", 3));

		GameObject* bgmSlider = (new GameObject("BGM Volume Slider"))
			->addGUIComponent(new GUISlider(glm::vec4(0.4f, 0.2f, 0.05f, 0.5f), glm::vec4(0.0f)));

		GameObject* bgmBox = (new GameObject("BGM Volume Text Box"))
			->addGUIComponent(new GUITextBox(glm::vec4(0.37f, 0.7f, 0.11f, 0.09f), glm::vec4(0.0f, 8.0f, 0.0f, 0.0f), "0", 3));
		...
		addToRoot((new GameObject("Options Menu"))
			...
			->addGUIComponent(new GUIButton(glm::vec4(0.375f, 0.85f, 0.25f, 0.08f), glm::vec4(0.0f), "Back",
