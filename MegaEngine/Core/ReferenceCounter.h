...
/// <summary>Stores a reference counter. May be used to count how many times an object is copied by reference.</summary>
class ReferenceCounter
{
public:
	/// <summary>Contructs ReferenceCounter and sets the reference counter to 1.</summary>
	ReferenceCounter() :
		m_refCount(1) {}
	...
	/// <summary>Adds 1 to the reference counter.</summary>
	inline void addReference() { m_refCount++; }
	/// <summary>Removes 1 from the reference counter.</summary>
