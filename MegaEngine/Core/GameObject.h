...
/// <summary>The entity object placed in the scene. 
/// Also stores the game componeents like Mesh Renderer and Cameras.</summary>
class GameObject
{
public:
	/// <summary>Contructs the GameObject and its position, rotation and scale.</summary>
	...
	/// <summary>Updates all children GameObjects, Game Components and GUI Components.
	/// <param name='delta'>The delta time between frames.</param>
	void updateAll(float delta);
	/// <summary>Renders all children GameObjects, Game Components and GUI Components.
	...
	/// <summary>Processes all inputs for the children GameObjects, Game Components and GUI Components.
	/// <param name='input'>The manager to get inputs from the viewport.</param>
	/// <param name='delta'>The delta time between frames.</param>
	void processAll(const InputManager& input, float delta);

	/// <summary>Adds a child GameObject then returns the child GameObject.</summary>
	/// <param name='child'>The child GameObject to add.</param>
	/// <returns>Returns the GameObject added.</returns>
	GameObject* addChild(GameObject* child);
	/// <summary>Attaches a Game Component to the GameObject.</summary>
	...
	/// <summary<Removes the specified GUI Components.</summary>
	...
	/// <summary>Gets the Game Component if it is attached.</summary>
...
private:
	...
	std::string m_name;
	/// <summary>The vector of child GameObjects.</summary>
	std::vector<GameObject*> m_children;
	/// <summary>The vector of attached Game Components.</summary>
	std::vector<GameComponent*> m_gameComponents;
	/// <summary>The vector of attached GUI Components.</summary>
	std::vector<GUIComponent*> m_guiComponents;
	/// <summary>The Transform object for the GameObject.</summary>
	Transform m_transform;
	/// <summary>A pointer to the Core Engine object.</summary>
