...
void AudioSource::setSoundPosition(glm::vec3 pos) { m_soundSource.setSoundPosVel(pos); }

void AudioSource::setStreamPosition(glm::vec3 pos) { m_streamSource.setStreamPosVel(pos); }
...
void AudioSource::setupSoundCone(glm::vec3 orient, float iCA, float oCA, float oVol)
{
