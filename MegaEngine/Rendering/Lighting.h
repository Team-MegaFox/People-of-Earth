...
{
public:
	DirectionalLight(const glm::vec3& color = glm::vec3(0.0f, 0.0f, 0.0f), float intensity = 0, int shadowMapSizeAsPowerOf2 = 0,
...
{
public:
	SpotLight(const glm::vec3& color = glm::vec3(0.0f, 0.0f, 0.0f), float intensity = 0, const Attenuation& atten = Attenuation(), float viewAngle = glm::radians(170.0f),
