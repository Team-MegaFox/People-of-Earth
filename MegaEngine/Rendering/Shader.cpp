...
void Shader::setUniformPxVec3(const std::string& uniformName, const glm::vec3& value) const
{
	glUniform3f(m_shaderData->getUniformMap().at(uniformName), value.x, value.y, value.z);
}

void Shader::setUniformPxMat44(const std::string& uniformName, const glm::mat4& value) const
{
