...
public:
	...
	/// </summary>
	/// <returns>A const reference to the map of uniforms in the shader prog
...
public:
	...
	/// <param name="uniformName">Name of the uniform.</param>
	/// <param name="value">The value of the uniform.</param>
	void setUniformPxMat44(const std::string& uniformName, const PxMat44& value) const;
	/// <summary>
	/// Sets the 3D vector uniform.
	/// </summary>
	/// <param name="uniformName">Name of the uniform.</param>
	/// <param name="value">The value of the uniform.</param>
	void setUniformPxVec3(const std::string& uniformName, const PxVec3& value) const;
protected:
private:
	/// <summary>
	/// The map of every <see cref="ShaderData"/>.
	/// </summary>
