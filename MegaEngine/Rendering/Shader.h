...
public:
	...
	void setUniformPxMat44(const std::string& uniformName, const glm::mat4& value) const;
	void setUniformPxVec3(const std::string& uniformName, const glm::vec3& value) const;
protected:
private:
